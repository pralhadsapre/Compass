package com.tcssamples.compass;
 ...
 */
public class CompassNorthProvider
		implements
			SensorEventListener,
			LocationListener {
	public static final String TAG = "CompassNorthProvider";
	 ...
	 */
	private CompassAverageAngle mAzimuthRadians;
	 ...
	 *            Application Context
	 */
	public CompassNorthProvider(Context context) {
	 ...
	 *            listener
	 */
	public CompassNorthProvider(Context context, int smoothing,
		...
		mAzimuthRadians = new CompassAverageAngle(smoothing);
	}
	...
	public void start() {
		...
		for (final String provider : mLocationManager.getProviders(true)) {
			if (LocationManager.GPS_PROVIDER.equals(provider)
				...
				mLocationManager.requestLocationUpdates(provider, 0, 100.0f,
						this);
			}
		}
	}
