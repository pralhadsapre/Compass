...
public class PlaceArrayAdapter
		extends
			ArrayAdapter<PlaceArrayAdapter.PlaceAutocomplete>
		implements
			Filterable {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View rowView = inflater.inflate(R.layout.prompt_item, parent, false);
	...
	private ArrayList<PlaceAutocomplete> getPredictions(CharSequence constraint) {
		if (mGoogleApiClient != null) {
			...
			Iterator<AutocompletePrediction> iterator = autocompletePredictions
					.iterator();
			ArrayList<PlaceAutocomplete> resultList = new ArrayList<PlaceAutocomplete>(
					autocompletePredictions.getCount());
